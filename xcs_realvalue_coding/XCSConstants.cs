...
namespace xcs
{
    class XCSConstants
    {
        ...
        public static int theta_sub = 63; //See the class "TheoreticalSetting" to use a theoretical value for a given problem
